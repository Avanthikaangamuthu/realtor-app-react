  ...
  useEffect(()=>{
    ...
    async function fetchListing(){
        ...
        if(docSnap.exists()){
            ...
            setFormdata({...docSnap.data(),latitude:docSnap.data().geolocation.lat,
        ...
        <form onSubmit={onSubmit}>
            ...
            <div className='flex space-x-6 justify-start mb-6'>
              <div>
                ...
                <input type='text' id='latitude' value={latitude} onChange={onChange} required min="-180" max="180" className='w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition ease-in-out duration-150 focus:bg-white focus:text-gray-700 focus:border-slate-600 text-center'/>
              </div>
              <div>
                <p className='text-lg font-semibold'>Longitude</p>
                <input type='text' id='longitude' value={longitude} onChange={onChange} min="-180" max="180" required className='w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition ease-in-out duration-150 focus:bg-white focus:text-gray-700 focus:border-slate-600 text-center'/>
              </div>
            </div>
            ...
            <button type='submit' className='mb-6 w-full bg-blue-600 text-white px-7 py-3 font-medium text-sm uppercase rounded shadow-md hover:shadow-lg hover:bg-blue-700 active:bg-blue-800 active:shadow-lg transition ease-in-out duration-150'>Update Listing</button>
        </form>
    </main>
  )
}
